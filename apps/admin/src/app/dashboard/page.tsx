...
import { getUserCounts, getCoffeeCount, getInquiryCounts, getUsers, getInquiries } from '@greenacres/db';
            ...
            `}>
                <CardContent className="p-6">
                    <div className="flex items-start justify-between mb-4">
                        <div className={`stat-icon ${iconBgClasses[color]}`}>
                            {icon}
                        </div>
                        {trend && (
...
function QuickActionCard({ title, description, href, icon, stats, delay = 0 }: QuickActionCardProps) {
    return (
        <div
            className="animate-fade-in-up opacity-0"
            style={{ animationDelay: `${delay}ms`, animationFillMode: 'forwards' }}
    ...
    return (
        <div className="flex items-center gap-4 p-4 rounded-xl hover:bg-gold/5 transition-colors group">
            ...
            <div className="flex-1 min-w-0">
                ...
                <p className="text-cream/50 text-sm capitalize">{inquiry.status.replace('_', ' ')}</p>
            </div>
            <Link
    ...
    useEffect(() => {
        async function loadDashboardData() {
            try {
                ...
                const [userCounts, coffeeCount, inquiryCounts, users, inquiries] = await Promise.all([
                    getUserCounts(),
                    getCoffeeCount(),
                    getInquiryCounts(),
                    getUsers(),
            ...
            <div className="min-h-screen flex items-center justify-center p-6">
                <Card className="glass-card max-w-md w-full">
                    <CardContent className="p-8 text-center">
                        ...
                        <h3 className="text-xl font-semibold text-cream mb-2">Error Loading Dashboard</h3>
        ...
        <div className="min-h-screen p-4 sm:p-6 lg:p-8">
            ...
            <header className="mb-6 lg:mb-8 animate-fade-in">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-gold text-sm font-medium uppercase tracking-wider">Dashboard</span>
                </div>
            ...
            <section className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
                    ...
                    <QuickActionCard
                        ...
                        stats={[
                            { label: 'Products', value: stats?.totalCoffees || 0 }
                        ]}
                        delay={200}
                    />
                    <QuickActionCard
