        ...
        <div ref={containerRef} className="min-h-screen flex items-center justify-center bg-forest-deep px-4 py-12 relative overflow-hidden">
            ...
            <Card className="login-card w-full max-w-md relative glass-card border-none mx-2 sm:mx-0">
                <CardHeader className="text-center space-y-4 p-6 sm:p-8">
                    <div className="mx-auto w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-gold to-gold-dark rounded-full flex items-center justify-center shadow-glow mb-2">
                        <ShieldCheck className="w-6 h-6 sm:w-8 sm:h-8 text-forest-deep" />
                    </div>
                    <div>
                        <CardTitle className="text-2xl sm:text-3xl font-serif text-cream">Admin Portal</CardTitle>
