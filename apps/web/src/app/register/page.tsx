...
import {
  ...
  CoffeeBranchImage,
} from "@/components/CoffeeDecorationsImage";
          ...
          <CardContent className="pt-10 pb-10 text-center space-y-6">
            ...
            <div className="success-item space-y-2">
              ...
              <p className="text-muted-foreground">
                Thank you for registering with Green Acres Coffee Trading. Your
            ...
            <div className="success-item bg-forest/40 border border-gold/10 rounded-xl p-6 text-left backdrop-blur-md">
              ...
              <ul className="text-sm text-muted-foreground space-y-3">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-gold">•</span>
                  After approval, you can access live pricing and submit
                  inquiries
                </li>
              </ul>
            </div>
    ...
    >
      ...
      <Card className="register-card w-full max-w-lg relative glass-card border-none z-10 mx-2 sm:mx-0">
        <CardHeader className="text-center space-y-4 pb-2 p-6 sm:p-8">
          <div className="mx-auto relative w-20 h-20 sm:w-24 sm:h-24 mb-4 drop-shadow-lg">
            <Image
              src="/logo_golden.svg"
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-6 sm:space-y-8 p-6 sm:p-8">
            ...
            <div className="form-section space-y-5">
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                <div className="space-y-2 sm:col-span-2">
                  <Label htmlFor="companyName" className="text-cream-muted">
                    Company Name *
                  </Label>
                  <Input
                    id="companyName"
                ...
                <div className="space-y-2">
                  <Label htmlFor="companyType" className="text-cream-muted">
                    Company Type *
                  </Label>
                  <Select
                    ...
                    <SelectContent className="bg-forest-dark border-gold/20 text-cream backdrop-blur-xl">
                      {COMPANY_TYPES.map((type) => (
                        <SelectItem
                          key={type.value}
                          value={type.value}
                          className="text-cream focus:bg-gold/20 focus:text-gold cursor-pointer"
                        >
                          {type.label}
                        </SelectItem>
                      ))}
                ...
                <div className="space-y-2">
                  <Label htmlFor="country" className="text-cream-muted">
                    Country *
                  </Label>
                  <Select
            ...
            <div className="form-section space-y-5">
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="contactPerson" className="text-cream-muted">
                    Contact Person *
                  </Label>
                  <Input
                    id="contactPerson"
            ...
            <div className="form-section space-y-5">
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="confirmPassword" className="text-cream-muted">
                    Confirm Password *
                  </Label>
                  <Input
                    id="confirmPassword"
          ...
          <CardFooter className="flex flex-col gap-5 pt-4 p-6 sm:p-8">
            ...
            <p className="form-section text-sm text-neutral-400 text-center">
              ...
              <Link
                href="/login"
                className="text-gold hover:text-gold-light font-medium transition-colors hover:underline underline-offset-4"
              >
                Sign in
              </Link>
            </p>
