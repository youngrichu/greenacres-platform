...
const values = [
  {
    ...
    description:
      "Strict physical inspection and regular cupping ensure only the finest beans reach our partners.",
    icon: Sparkles,
  },
  {
    title: "Full Traceability",
    description:
      "Lot traceability from origin to export with transparent documentation and shipment consistency.",
    icon: MapPin,
  },
  {
    title: "Sustainable Growth",
    description:
      "Empowering farmers through fair trade practices and building long-term supplier relationships.",
    icon: Sprout,
  },
  {
    title: "Global Reach",
    description:
      "Flexible export solutions via FOB Djibouti, with CAD, LC, and repeat-buyer arrangements.",
    icon: Globe,
  },
];
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          <div className="about-header-item">
            ...
            <div className="space-y-6 text-foreground-muted text-lg leading-relaxed">
              ...
              <p>
                Greenacres Industrial PLC is a licensed Ethiopian exporter of
                premium Arabica green coffee beans. Headquartered in Addis
                Ababa, we source coffee from the country&apos;s most renowned
                origins, including Sidama, Guji, Yirgacheffe, Limu, Kaffa,
                Jimma, Teppi, and Andrecha.
              </p>
              <p>
                We supply international coffee roasters and traders across
                Europe, the Middle East, Asia, and North America. Our company
                combines deep local sourcing knowledge with international trade
                expertise to deliver reliable, traceable, and competitively
                priced Ethiopian coffees.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-3 mt-10">
              <Badge
                variant="outline"
                className="text-forest border-forest/20 bg-forest/5 px-4 py-2 text-sm gap-2"
              >
                <CheckCircle2 className="w-4 h-4" /> Coffee & Tea Authority
                Registered
              </Badge>
              <Badge
                variant="outline"
          ...
          <div className="relative about-header-item">
            <div className="aspect-[4/5] rounded-[3rem] overflow-hidden shadow-2xl relative">
              <CldImage
                src="coffee/images/story/warehouse-processing" // Placeholder for high-quality image
              ...
              <div className="absolute bottom-8 left-8 right-8">
                <p className="text-white text-xl font-playfair italic">
                  &quot;Our mission is to source and export premium Ethiopian
                  coffee with care, transparency, and integrity.&quot;
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-24">
          <div className="glass-cream p-12 rounded-3xl border border-gold/10 about-header-item">
            ...
            <p className="text-foreground-muted leading-relaxed">
              To become one of Ethiopia&apos;s most trusted and innovative
              coffee exporters, recognized globally for quality excellence,
          ...
          <div className="glass-cream p-12 rounded-3xl border border-forest/10 about-header-item">
            ...
            <ul className="space-y-3 text-foreground-muted">
              <li className="flex gap-2">
                <span className="text-gold">•</span> Empower farmers and local
                suppliers through fair trade practices.
              </li>
              <li className="flex gap-2">
                <span className="text-gold">•</span> Ensure consistent quality
                through rigorous cupping and grading standards.
              </li>
              <li className="flex gap-2">
                <span className="text-gold">•</span> Meet global demand with
                reliable logistics and exceptional service.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="text-center mb-16">
          <h2
            className="text-3xl sm:text-4xl font-bold text-forest mb-4"
            style={{ fontFamily: "var(--font-playfair)" }}
          >
            The Green Acres Difference
          </h2>
          <p className="text-foreground-muted max-w-2xl mx-auto">
            Why international roasters choose us as their preferred Ethiopian
            partner.
          </p>
        </div>
        ...
        <div ref={teamRef} className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {team.map((member, i) => (
            <div
              key={member.name}
              className="team-card group relative bg-white rounded-3xl p-6 shadow-xl shadow-forest/5 border border-cream-dark transition-all duration-500 hover:-translate-y-2"
            >
