...
export default function Introduction() {
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center px-6" ref={textRef}>
                <p className="text-xl md:text-2xl text-foreground/80 leading-relaxed font-light mb-10">
                    ...
                    we source and export the finest Arabica beans that define the true essence of Ethiopian coffee culture.
                </p>
                ...
                <div className="flex flex-wrap justify-center gap-6">
                    ...
                    >
                        <Link href="/portal/inquiries" className="group flex items-center gap-2">
