...
const missionPoints = [
  {
    ...
    description:
      "Empower farmers and local suppliers through equitable partnerships and transparent pricing.",
  },
  {
    icon: Award,
    title: "Rigorous Quality Standards",
    description:
      "Ensure consistent quality through expert cupping, grading standards, and meticulous processing.",
  },
  {
    icon: Truck,
    title: "Reliable Global Logistics",
    description:
      "Meet global demand with dependable logistics, timely delivery, and exceptional customer service.",
  },
];
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        ...
        { x: -50, opacity: 0 },
        {
          ...
          ease: "power3.out",
          scrollTrigger: {
            trigger: ".mv-fade", // Trigger with the container
            start: "top 70%",
          },
        },
      );
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 mv-fade">
            ...
            <div className="overflow-hidden mb-6">
              <h2
                className="text-4xl md:text-5xl font-bold text-forest origin-left"
            ...
            <p className="text-lg md:text-xl text-foreground-muted leading-relaxed">
              ...
              integrity, and sustainable partnerships. We envision a future
              where every cup tells the story of its origin.
            </p>
          </div>
