        ...
        >
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                ...
                <div className="absolute -top-12 -left-12 w-[350px] h-[350px] opacity-[0.08]">
                    <CoffeeLeafImage className="w-full h-full -rotate-45" variant="light-ink" />
                </div>
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6">
                ...
                <div ref={teamRef} className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6">
                    {team.map((member, i) => (
                        <div key={member.name} className="team-card group relative bg-white/5 backdrop-blur-sm rounded-3xl p-6 border border-white/10 hover:border-gold/50 transition-all duration-500 hover:-translate-y-2 hover:bg-white/10">
