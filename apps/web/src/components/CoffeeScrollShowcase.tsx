  ...
  return (
    <div ref={wrapperRef} className="relative z-20 bg-cream">
      ...
      >
        ...
        <div
          ref={flavorBgRef}
          className="absolute bottom-0 md:top-0 right-0 w-full h-[45%] md:w-1/2 md:h-full overflow-hidden pointer-events-none z-[1]"
        >
        ...
        {/* ═══ COUNTER ═══ */}
        <div className="absolute bottom-8 left-4 md:bottom-8 md:left-10 z-30 flex items-end gap-1">
          <span
            ref={counterRef}
        ...
        <div className="relative z-10 h-full flex flex-col md:flex-row">
          ...
          <div className="w-full h-[45%] md:w-1/2 md:h-full flex items-start md:items-center justify-center md:justify-start px-6 md:pl-16 md:pr-20 pt-3 md:pt-0 pb-16 md:pb-0 relative z-10 overflow-y-auto">
            <div
              ref={detailsRef}
