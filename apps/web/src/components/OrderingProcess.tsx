...
const steps: Step[] = [
  {
    ...
    description:
      "Browse our current harvest menu and request a detailed offer. Specify your desired volume, grade (G1-G5), and processing method.",
    icon: FileText,
  ...
  },
  {
    ...
    description:
      "We ship 300g pre-shipment samples (PSS) via DHL/FedEx for your cupping and approval before finalizing the contract.",
    icon: Copy,
    duration: "3-5 Days",
  ...
  },
  {
    ...
    description:
      "Upon sample approval, we sign the Sales Contract. You arrange payment (LC, CAD, or TT) as per the agreed terms.",
    icon: CheckSquare,
    duration: "1 Week",
  ...
  },
  {
    ...
    title: "Processing & QC",
    description:
      "Your coffee is milled, color-sorted, and hand-picked at our Addis facility. Our Q-Graders perform final quality checks.",
    icon: Package,
    duration: "10-14 Days",
  ...
  },
  {
    ...
    description:
      "We handle all export documentation, load the container, and transport to Djibouti port for global shipping.",
    icon: Truck,
    duration: "Ongoing",
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="opacity-10">
          <CoffeeBeansScatteredImage
            className="absolute top-20 right-10 w-64 h-64 rotate-12"
            variant="light-ink"
          />
          <CoffeeBeansScatteredImage
            className="absolute bottom-40 left-10 w-48 h-48 -rotate-45"
            variant="light-ink"
          />
        </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-white/60 max-w-2xl mx-auto text-lg">
            A transparent, streamlined process designed for international
                ...
                <div className="mt-auto pt-4 border-t border-white/10">
                  ...
                  <div className="flex flex-wrap gap-2 justify-center lg:justify-start">
                    {step.deliverables?.map((item, i) => (
                      <span
                        key={i}
                        className="text-[10px] px-2 py-1 rounded bg-white/5 text-white/50 border border-white/5"
                      >
                        {item}
                      </span>
                    ))}
          ...
          <div className="glass-dark p-8 md:p-12 rounded-3xl border border-gold/10 relative overflow-hidden">
            ...
            <div className="grid lg:grid-cols-3 gap-12 relative z-10">
              ...
              <div className="lg:col-span-1 border-b lg:border-b-0 lg:border-r border-white/10 pb-8 lg:pb-0 lg:pr-8">
                <h4 className="text-gold text-sm font-bold uppercase tracking-widest mb-2">
                ...
                <p className="text-white/60 text-sm leading-relaxed mb-8">
                  We build long-term relationships based on consistency,
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div className="text-sm">
                      ...
                      <span className="text-white/60">
                        FOB Djibouti (CFR/CIF upon request)
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div className="text-sm">
                      ...
                      <span className="text-white/60">
                        CAD, LC at sight, TT (Deposit + Balance)
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div className="text-sm">
                      ...
                      <span className="text-white/60">
                        From 10 bags microlots to FCL (Full Container Loads)
                      </span>
                    </div>
                  </li>
                </ul>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <div className="text-sm">
                      ...
                      <span className="text-white/60">
                        ICO Certificate of Origin, Phyto, Weight/Quality Cert,
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div className="text-sm">
                      ...
                      <span className="text-white/60">
                        Pre-shipment samples sent via DHL/FedEx for final
                        approval
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div className="text-sm">
                      ...
                      <span className="text-white/60">
                        60kg Jute bags with GrainPro lining for freshness
                      </span>
                    </div>
                  </li>
                </ul>
