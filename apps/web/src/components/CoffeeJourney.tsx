      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-foreground-muted max-w-2xl mx-auto text-lg">
            ...
            artisan craftsmanship, and a commitment to excellence that spans
            generations.
          </p>
        </div>
        ...
        <div ref={stepsRef} className="relative">
          ...
          <div className="space-y-16 md:space-y-24">
            {journeySteps.map((step, index) => (
              <div
                key={step.number}
                className={`journey-step flex flex-col md:flex-row items-center gap-8 ${
              ...
              >
                ...
                >
                  <div
                    className={`bg-white rounded-2xl p-8 shadow-md border border-cream-dark hover:shadow-xl hover:border-gold/30 transition-all duration-300 ${
